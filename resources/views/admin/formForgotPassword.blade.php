...
<head>
    ...
    <title>Sistema da AIX da BH Commerce - Esqueceu sua senha?</title>
...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">Esqueceu sua senha? Informe o seu email e solicite uma nova.</p>

            <form action="" id="formEsqueceuSuaSenha" method="post">
                <input type="hidden" value="{{env('APP_URL')}}" id="urlEsqueceuSuaSenha" name="urlEsqueceuSuaSenha">
