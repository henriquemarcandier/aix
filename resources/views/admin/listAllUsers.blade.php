        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modalCadastro" onclick=addUsuario()>Criar Novo</button>
                    </div>
                    <div class="col-sm-4">
...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <div class="media text-muted pt-3" id="filtro" style="display:none">
        ...
        <button type="button" class="btn btn-primary" onclick='verificaNovamente("usuarios", "{{env('APP_URL')}}","{{$_SESSION['user']['id']}}")'>Filtrar</button>
    </div>
...
<div class="modal fade" id="modalVisualizacao" tabindex="-1" role="dialog" aria-labelledby="modalVisualizacao" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="visualizacaoUsuarios">
                <img src="{{env('APP_URL')}}img/loader.gif" width="20"> Aguarde... Carregando...
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
...
<script>
    window.setInterval('verificaNovamente("usuarios", "{{env('APP_URL')}}", "{{$_SESSION['user']['id']}}")', 60000); window.setTimeout('verificaNovamente("usuarios", "{{env('APP_URL')}}", "{{$_SESSION['user']['id']}}")', 2000);
</script>
