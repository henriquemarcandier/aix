...
class StudentController extends Controller
{
    ...
    public function index()
    {
        if (!isset($_SESSION['user'])) {
            ?><script>location.href='<?php echo env('APP_URL')?>login?page=alunos';</script><?php
        } else {
            $student = Student::all();
            ...
            if ($permissao && $permissao->view) {
                ...
                $Logs->action = "Visualizou os Alunos";
                $Logs->save();
                return view('admin.listAllStudents', [
                    'states' => $states,
                    'courses' => $courses,
