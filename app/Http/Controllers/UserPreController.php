...
class UserPreController extends Controller
{
    /**
        ...
        if(isset($_SESSION['user']['id'])) {
            ...
            $param = 'usuarios-pre';
                if ($permissao && $permissao->view) {
                    ...
                    $Logs->save();
                    return view('admin.listAllUsersPre', [
                        'users' => $users,
            ...
            ?><script>location.href='<?php echo env('APP_URL')?>login?page=usuarios-pre';</script><?php
        }
    }
    /**
